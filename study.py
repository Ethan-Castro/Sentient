...
def main():
    ...
    st.write("Hey, my goal is to help you excel academically by using resources from top institutions and professionals./n Everyone deserves a fair shot at greatness.")
