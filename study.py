...
def main():
    ...
    st.write("Hey, my mission is to help you excel academically, regardless of your current setting.")
    
    user_input = st.text_input("In the box below introduce yourself, and let me know what you need help with. \n You can chat back and forth as well. It may take up to 20 seconds to get an answer.")
    if user_input:
