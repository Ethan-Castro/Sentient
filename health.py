...
if st.button('Get advice'):
    ...
    "and a brief exercise routine, a philosophical motivational quote, a piece of nutrition psychology advice, healthy snacks, and words for consistency. "
    "{advice}. Repeat everything before (not after) 'and a brief...' and input the proper values"
)
