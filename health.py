...
if st.button('Get advice'):
    ...
    response = openai.Completion.create(
        ...
        prompt=f"I am an AI health coach. You told me that you are {age} years old, weigh {weight} kg, are {height} cm tall, and your goal is {goal}. Here's your BMI, Probable Basal Metabolic Rate, and some advice.: ",
        temperature=0.5,
        max_tokens=100
    )
