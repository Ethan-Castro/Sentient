...
if st.button('Get advice'):
    # Generate AI response
     ...
     prompt_template = (
    "REPEAT THIS SCRIPT before everytime with the sex, age, weight, height, goal, activity, that the USER puts. I am an AI health coach. You told me that you are {age} years old, weigh {weight} lbs, "
